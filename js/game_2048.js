var Game = (function () {
    ...
    Game.prototype = {
        ...
        save: function () {
            localStorage.bestScore_2048 = data.best;
            localStorage.gameState_2048 = JSON.stringify({
                cell: data.cell,
                socre: data.score,
            });
        },
        ...
        setBest: function () {
            var best = getLocalStorage('bestScore_2048');
            data.best = best || 0;
        },
        getHistory: function () {
            var gameState = getLocalStorage('gameState_2048');
