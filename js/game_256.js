var Game = (function () {
    ...
    Game.prototype = {
        ...
        save: function () {
            localStorage.bestScore_256 = data.best;
            localStorage.gameState_256 = JSON.stringify({
                cell: data.cell,
                socre: data.score,
            });
        },
        ...
        setBest: function () {
            var best = getLocalStorage('bestScore_256');
            data.best = best || 0;
        },
        getHistory: function () {
            var gameState = getLocalStorage('gameState_256');
