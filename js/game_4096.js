var Game = (function () {
    ...
    Game.prototype = {
        ...
        save: function () {
            localStorage.bestScore_4096 = data.best;
            localStorage.gameState_4096 = JSON.stringify({
                cell: data.cell,
                socre: data.score,
            });
        },
        ...
        setBest: function () {
            var best = getLocalStorage('bestScore_4096');
            data.best = best || 0;
        },
        getHistory: function () {
            var gameState = getLocalStorage('gameState_4096');
