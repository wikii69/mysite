var Game = (function () {
    ...
    Game.prototype = {
        ...
        save: function () {
            localStorage.bestScore_8192 = data.best;
            localStorage.gameState_8192 = JSON.stringify({
                cell: data.cell,
                socre: data.score,
            });
        },
        ...
        setBest: function () {
            var best = getLocalStorage('bestScore_8192');
            data.best = best || 0;
        },
        getHistory: function () {
            var gameState = getLocalStorage('gameState_8192');
