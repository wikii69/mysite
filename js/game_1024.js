var Game = (function () {
    ...
    Game.prototype = {
        ...
        save: function () {
            localStorage.bestScore_1024 = data.best;
            localStorage.gameState_1024 = JSON.stringify({
                cell: data.cell,
                socre: data.score,
            });
        },
        ...
        setBest: function () {
            var best = getLocalStorage('bestScore_1024');
            data.best = best || 0;
        },
        getHistory: function () {
            var gameState = getLocalStorage('gameState_1024');
